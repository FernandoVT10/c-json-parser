...
char* string_dump(String *str); // needs to be freed
...
// returns a formatted text. NOTE: the string changes everytime the function is called
// since it uses an static buffer
